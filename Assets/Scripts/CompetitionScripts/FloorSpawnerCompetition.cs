...
public class FloorSpawnerCompetition : MonoBehaviour
{
    public int sizeX;
    public int sizeZ;
    ...
    private void Start()
    {
        ...
        GameObject floorzone = (GameObject)Instantiate(Resources.Load("Village2"), new Vector3(Random.Range(-floorX, -floorZ), 0F, Random.Range(-floorZ, floorZ)), Quaternion.identity);
        floorzone.tag = ("Zone");
        FloorZoneCompetition floorzoneScript = floorzone.GetComponent(typeof(FloorZoneCompetition)) as FloorZoneCompetition;
