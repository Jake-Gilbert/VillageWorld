...
public class FloorSpawnerEvolution : MonoBehaviour
{
        public int sizeX;
        public int sizeZ;
        ...
        private void Start()
        {
            ...
            GameObject floorzone = (GameObject)Instantiate(Resources.Load("CollectionZoneEvolution"), new Vector3(Random.Range(-floorX, -floorZ), 0F, Random.Range(-floorZ, floorZ)), Quaternion.identity);
            floorzone.tag = ("Zone");
            FloorZoneEvolution floorzoneScript = floorzone.GetComponent(typeof(FloorZoneEvolution)) as FloorZoneEvolution;
